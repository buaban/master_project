dojo.provide("html5FinancialCharts.CustomYieldCurveChart");

dojo.declare("html5FinancialCharts.CustomYieldCurveChart", null, {
	...
	fillSeriesParamList: function (customData) {
		...
		for (var i = 0; i < customData.length; i++) {
			...
			var seriesParam = new TRWebchart_Shared.SeriesParam(
				...
				TRWebchart_Shared.ChartType.YieldCurve,
				'DaysToMaturity',
				['Value'],
				'1',
